      ...
      >
        ...
        >
          <Stack spacing={0} justifyContent='center' alignItems='center'>
            <Typography variant='h5' align='center' fontWeight={600} color='white'>OUR STORE</Typography>
            <Breadcrumbs aria-label="breadcrumb" separator="|" sx={{ alignItems: 'center' }} color='white'>
